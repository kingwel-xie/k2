          ...
          >
            ...
            <template slot-scope="scope">
              <el-popover trigger="hover" placement="top">
                <p><span v-if="scope.row.type=='CHECK' && scope.row.title!=''"><el-tag type="success">{{ '['+scope.row.type +'] '+ scope.row.title }}</el-tag></span>
                  <span v-if="scope.row.type!='CHECK' && scope.row.title!=''"><el-tag type="">{{ '['+scope.row.type +'] '+scope.row.title }}</el-tag></span>
                  <span v-if="scope.row.title==''"><el-tag type="danger">暂无</el-tag></span>
                </p>
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
              ...
              <el-form-item label="类型" prop="type">
                <el-select
                  ...
                  @keyup.enter.native="handleQuery"
                >
                  <el-option value="CHECK">CHECK</el-option>
                  <el-option value="NOCHECK">NOCHECK</el-option>
                </el-select>
              </el-form-item>
