...
<script lang="ts" setup name="TbxCountry">
  ...
  import { GenericExport, GenericExportModalAction } from '/@/views/kobh/components/GenericExport';
  ...
  async function _handleExport(event, filteredHeaders: Recordable) {
    ...
    export2ExcelV2(filteredHeaders, columns, data, '国家编码.xlsx');
  }
</script>
